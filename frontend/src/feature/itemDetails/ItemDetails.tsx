...
import { useAuth } from "@/firebase/AuthProvider";  // retrive current user status
...
const ItemDetails: React.FC<ItemDetailsProps> = () => {
  ...
  const { itemId } = useParams(); // retrive route parameter itemId
  ...
  // Function to filters and maps related products based on the current item's category.
  const renderRelatedProducts = () => {
    //Checks if the item and its category are available.
